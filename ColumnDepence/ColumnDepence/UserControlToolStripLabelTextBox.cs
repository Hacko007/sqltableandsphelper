...
namespace hackovic.DbInfo
{
    ...
    public partial class UserControlToolStripLabelTextBox : ToolStripControlHost
    {
        ...
        {
            get { return CustomControlLabelTextBox != null ? CustomControlLabelTextBox.LabelText : ""; }
            set
            {
        ...
        {
            get { return CustomControlLabelTextBox != null ? CustomControlLabelTextBox.TextBox : null; }
        }
        ...
        {
            get { return CustomControlLabelTextBox != null ? CustomControlLabelTextBox.ValueType : typeof(string); }
            set
            {
                if (CustomControlLabelTextBox != null)
                {
                    CustomControlLabelTextBox.ValueType = value;
                }
            }
        }
    }
